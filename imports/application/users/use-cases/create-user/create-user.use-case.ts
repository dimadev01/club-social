...
import { UserModelDto } from '@application/users/dtos/user-model.dto';
...
import { CreateUserRequest } from '@domain/users/user.types';

@injectable()
export class CreateUserNewUseCase<TSession>
  implements IUseCase<CreateUserRequest<TSession>, UserModelDto>
{
  public constructor(
  ...
  ): Promise<Result<UserModelDto, Error>> {
