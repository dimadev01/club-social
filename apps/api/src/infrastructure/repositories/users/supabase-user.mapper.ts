...
export abstract class SupabaseUserMapper {
  public static toDomain(record: UserInterface): UserEntity {
  ...
  public static toPersistence(user: UserEntity): UserInterface {
    return {
