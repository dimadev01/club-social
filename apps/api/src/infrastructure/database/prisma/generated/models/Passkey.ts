...
export type PasskeyScalarWhereWithAggregatesInput = {
  ...
  transports?:
    | Prisma.StringNullableWithAggregatesFilter<'Passkey'>
    | string
    | null;
  createdAt?:
    | Prisma.DateTimeNullableWithAggregatesFilter<'Passkey'>
    | Date
    | string
    | null;
...
export type PasskeyUpdateManyWithoutUserNestedInput = {
  ...
  disconnect?:
    | Prisma.PasskeyWhereUniqueInput
    | Prisma.PasskeyWhereUniqueInput[];
  ...
  updateMany?:
    ...
    | Prisma.PasskeyUpdateManyWithWhereWithoutUserInput[];
  deleteMany?:
    | Prisma.PasskeyScalarWhereInput
    | Prisma.PasskeyScalarWhereInput[];
};
...
> {
  ...
  >(
    args: Prisma.SubsetIntersection<T, PasskeyGroupByArgs, OrderByArg> &
      InputErrors,
  ): {} extends InputErrors
...
> = {
  ...
  data: Prisma.XOR<
    ...
    Prisma.PasskeyUncheckedCreateInput
  >;
};
...
> = {
   ...
   */
  data: Prisma.XOR<
    Prisma.PasskeyUpdateInput,
    Prisma.PasskeyUncheckedUpdateInput
  >;
  /**
...
> = {
  ...
  data: Prisma.XOR<
    Prisma.PasskeyUpdateManyMutationInput,
    Prisma.PasskeyUncheckedUpdateManyInput
  >;
  /**
